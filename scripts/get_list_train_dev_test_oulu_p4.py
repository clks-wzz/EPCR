...
dicts_path = {
    'train': {
            ...
            'save': '/share/wangzezheng/data/liveness/public/OULU/IJCB/txts/final/list_semi_train_oulu_p4.txt'
        },
    'dev': {
            'data': '/share/wangzezheng/data/liveness/public/OULU/IJCB/Dev_images',
            'save': '/share/wangzezheng/data/liveness/public/OULU/IJCB/txts/final/list_semi_dev_oulu_p4.txt'
        },
    'test': {
            'data': '/share/wangzezheng/data/liveness/public/OULU/IJCB/Test_images',
            'save': '/share/wangzezheng/data/liveness/public/OULU/IJCB/txts/final/list_semi_test_oulu_p4.txt'
        },
    'dev_test': {
            'data': None,
            'save': '/share/wangzezheng/data/liveness/public/OULU/IJCB/txts/final/list_semi_dev_test_oulu_p4.txt'
        }
}

protocol = 'ijcb_protocal_4'
