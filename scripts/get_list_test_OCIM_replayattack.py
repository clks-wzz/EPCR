...
path_imgs = '/share/wangzezheng/data/liveness/public/CASIA_ReplayAttack_images_test'
path_dst  = '/share/wangzezheng/data/liveness/public/OCIM/txts/final/list_semi_ocim_test_replayattack.txt'

frame_interval = 4

def main():
    FILES = glob.glob(os.path.join(path_imgs, 'ReplayAttack*'))
